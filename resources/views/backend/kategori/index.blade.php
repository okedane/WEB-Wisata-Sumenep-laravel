                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="float-right">
                                <form method="GET" action="{{ route('beCategory') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content">
                                                <a href="{{ route('beTravel.index', $k->id) }}"
                                                    class="btn btn-success btn-icon mr-2">
                                                    <i class="fas fa-eye"> Lihat Wisata </i>
                                                </a>
                                                ...
                                                <form action="{{ route('beCategory.destroy', $k->id) }}" method="POST"
