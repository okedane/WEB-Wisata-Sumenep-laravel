            ...
            <div class="card-body text-white card-hero position-absolute text-center">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active text-white" aria-current="page">{{ $kategori->title }}</li>
                    </ol>
                </nav>
                <h1 class="card-title card-title-hero">{{ $kategori->title }}</h1>
                <p class="card-text"></p>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 mb-5">
                    <div class="card" style="border: none">
                        @if ($item->image->isNotEmpty())
                            ...
                            <img src="{{ Storage::url('uploads/travel/' . $item->image->first()->image_path) }}"
                                style="height: 400px; object-fit: cover;" class="card-img-top" alt="{{ $item->title }}">
                        @else
